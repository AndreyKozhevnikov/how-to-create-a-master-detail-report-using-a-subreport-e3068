...
Namespace WinSolution3.Win
    Partial Public Class WinSolution3WindowsFormsApplication
        ...
        Private Sub WinSolution3WindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
